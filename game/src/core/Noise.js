// Deterministic noise toolkit shared by texture synthesis, terrain and FX.
// Everything is seeded so builds are reproducible frame-to-frame and run-to-run.
...
/** Classic simplex noise, seeded permutation table. */
...
/** Fractal brownian motion over any 2D noise source. */
export function fbm2(noise, x, y, octaves = 5, lacunarity = 2.0, gain = 0.5) {
...
/** Ridged multifractal — good for rock, cracked concrete, rust fronts. */
...
/**
 * Tileable worley/cellular noise. Returns {f1, f2, id} where f1 is distance to
 * the nearest feature point. Used for pebbles, chipped paint, cracked mud.
 */

...
1. **収集**: RSS（Google News / ITmedia AI+）から前日 0:00〜23:59（JST）に公開されたAI関連記事を収集し、重複タイトルを除外します。
2. **選定・要約**: 収集した記事一覧を Claude API に渡し、重要度の高い3件を選定させ、1ツイート分の投稿文を生成します。
3. **投稿**: X API v2（OAuth 1.0a User Context）で自動投稿します。
